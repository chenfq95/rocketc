...
export const buildMuiTheme = (theme: ThemeName, tokens: FlatTokenTheme): MuiThemeOptions => ({
  ...
  palette: {
    ...
    action: {
      active: colorToken(tokens, 'color.action.fg'),
      hover: colorToken(tokens, 'color.action.bgHover'),
      hoverOpacity: numberToken(tokens, 'opacity.action.bgHover'),
      selected: colorToken(tokens, 'color.action.bgSelected'),
      selectedOpacity: numberToken(tokens, 'opacity.action.bgSelected'),
      disabled: colorToken(tokens, 'color.action.fgDisabled'),
      disabledOpacity: numberToken(tokens, 'opacity.action.fgDisabled'),
      disabledBackground: colorToken(tokens, 'color.action.bgDisabled'),
      focus: colorToken(tokens, 'color.action.bgFocus'),
      focusOpacity: numberToken(tokens, 'opacity.action.bgFocus'),
      activatedOpacity: numberToken(tokens, 'opacity.action.bgActivated'),
    },
  },
