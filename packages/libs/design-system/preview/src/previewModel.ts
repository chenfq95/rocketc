...
export const chakraColorRoles = [
  ...
  ['Primary muted', 'colors.primary.muted', 'color.brand.softHover'],
  ['Primary subtle', 'colors.primary.subtle', 'color.brand.soft'],
  ['Primary emphasized', 'colors.primary.emphasized', 'color.brand.softActive'],
  ...
  ['Secondary muted', 'colors.secondary.muted', 'color.control.secondary.bgActive'],
  ['Secondary subtle', 'colors.secondary.subtle', 'color.control.secondary.bgHover'],
  ...
  ['Brand fg', 'colors.brand.fg', 'color.brand.fg'],
  ['Brand muted', 'colors.brand.muted', 'color.brand.softHover'],
  ['Brand subtle', 'colors.brand.subtle', 'color.brand.soft'],
  ['Brand emphasized', 'colors.brand.emphasized', 'color.brand.softActive'],
  ['Brand border', 'colors.brand.border', 'color.brand.border'],
  ['Brand focus ring', 'colors.brand.focusRing', 'color.brand.focusRing'],
  ['Success solid', 'colors.success.solid', 'color.success.solid'],
  ['Success contrast', 'colors.success.contrast', 'color.success.contrast'],
  ['Success fg', 'colors.success.fg', 'color.success.fg'],
  ['Success muted', 'colors.success.muted', 'color.success.softHover'],
  ['Success subtle', 'colors.success.subtle', 'color.success.soft'],
  ['Success emphasized', 'colors.success.emphasized', 'color.success.softActive'],
  ['Success border', 'colors.success.border', 'color.success.border'],
  ['Success focus ring', 'colors.success.focusRing', 'color.success.focusRing'],
  ['Warning solid', 'colors.warning.solid', 'color.warning.solid'],
  ['Warning contrast', 'colors.warning.contrast', 'color.warning.contrast'],
  ['Warning fg', 'colors.warning.fg', 'color.warning.fg'],
  ['Warning muted', 'colors.warning.muted', 'color.warning.softHover'],
  ['Warning subtle', 'colors.warning.subtle', 'color.warning.soft'],
  ['Warning emphasized', 'colors.warning.emphasized', 'color.warning.softActive'],
  ['Warning border', 'colors.warning.border', 'color.warning.border'],
  ['Warning focus ring', 'colors.warning.focusRing', 'color.warning.focusRing'],
  ['Danger solid', 'colors.danger.solid', 'color.danger.solid'],
  ['Danger contrast', 'colors.danger.contrast', 'color.danger.contrast'],
  ['Danger fg', 'colors.danger.fg', 'color.danger.fg'],
  ['Danger muted', 'colors.danger.muted', 'color.danger.softHover'],
  ['Danger subtle', 'colors.danger.subtle', 'color.danger.soft'],
  ['Danger emphasized', 'colors.danger.emphasized', 'color.danger.softActive'],
  ['Danger border', 'colors.danger.border', 'color.danger.border'],
  ['Danger focus ring', 'colors.danger.focusRing', 'color.danger.focusRing'],
  ['Info solid', 'colors.info.solid', 'color.info.solid'],
  ['Info contrast', 'colors.info.contrast', 'color.info.contrast'],
  ['Info fg', 'colors.info.fg', 'color.info.fg'],
  ['Info muted', 'colors.info.muted', 'color.info.softHover'],
  ['Info subtle', 'colors.info.subtle', 'color.info.soft'],
  ['Info emphasized', 'colors.info.emphasized', 'color.info.softActive'],
  ['Info border', 'colors.info.border', 'color.info.border'],
  ['Info focus ring', 'colors.info.focusRing', 'color.info.focusRing'],
