...
export const colorRoles = [
  ['Brand soft', 'brand.soft', 'var(--rc-color-brand-soft)', 'color.orange.50 / color.orange.950'],
  [
    'Brand soft hover',
    'brand.softHover',
    'var(--rc-color-brand-soft-hover)',
    'color.orange.100 / color.orange.900',
  ],
  [
    'Brand soft active',
    'brand.softActive',
    'var(--rc-color-brand-soft-active)',
    'color.orange.200 / color.orange.800',
  ],
  [
    'Brand border',
    'brand.border',
    'var(--rc-color-brand-border)',
    'color.orange.300 / color.orange.600',
  ],
  ['Brand focus ring', 'brand.focusRing', 'var(--rc-color-brand-focus-ring)', 'color.brand.border'],
  [
    'Brand foreground',
    'brand.fg',
    'var(--rc-color-brand-fg)',
    'color.orange.700 / color.orange.300',
  ],
  ['Brand solid', 'brand.solid', 'var(--rc-color-brand-solid)', 'color.orange.500'],
  [
    'Brand solid hover',
    'brand.solidHover',
    'var(--rc-color-brand-solid-hover)',
    'color.orange.600',
  ],
  [
    'Brand solid active',
    'brand.solidActive',
    'var(--rc-color-brand-solid-active)',
    'color.orange.700',
  ],
  ['Brand contrast', 'brand.contrast', 'var(--rc-color-brand-contrast)', 'color.white'],
  [
    'Success soft',
    'success.soft',
    'var(--rc-color-success-soft)',
    'color.green.50 / color.green.950',
  ],
  [
    'Success soft hover',
    'success.softHover',
    'var(--rc-color-success-soft-hover)',
    'color.green.100 / color.green.900',
  ],
  [
    'Success soft active',
    'success.softActive',
    'var(--rc-color-success-soft-active)',
    'color.green.200 / color.green.800',
  ],
  [
    'Success border',
    'success.border',
    'var(--rc-color-success-border)',
    'color.green.300 / color.green.700',
  ],
  [
    'Success focus ring',
    'success.focusRing',
    'var(--rc-color-success-focus-ring)',
    'color.success.border',
  ],
  [
    'Success foreground',
    'success.fg',
    'var(--rc-color-success-fg)',
    'color.green.700 / color.green.300',
  ],
  ['Success solid', 'success.solid', 'var(--rc-color-success-solid)', 'color.green.500'],
  [
    'Success solid hover',
    'success.solidHover',
    'var(--rc-color-success-solid-hover)',
    'color.green.600 / color.green.400',
  ],
  [
    'Success solid active',
    'success.solidActive',
    'var(--rc-color-success-solid-active)',
    'color.green.700 / color.green.300',
  ],
  ['Success contrast', 'success.contrast', 'var(--rc-color-success-contrast)', 'color.white'],
  [
    'Warning soft',
    'warning.soft',
    'var(--rc-color-warning-soft)',
    'color.amber.50 / color.amber.950',
  ],
  [
    'Warning soft hover',
    'warning.softHover',
    'var(--rc-color-warning-soft-hover)',
    'color.amber.100 / color.amber.900',
  ],
  [
    'Warning soft active',
    'warning.softActive',
    'var(--rc-color-warning-soft-active)',
    'color.amber.200 / color.amber.800',
  ],
  [
    'Warning border',
    'warning.border',
    'var(--rc-color-warning-border)',
    'color.amber.300 / color.amber.700',
  ],
  [
    'Warning focus ring',
    'warning.focusRing',
    'var(--rc-color-warning-focus-ring)',
    'color.warning.border',
  ],
  [
    'Warning foreground',
    'warning.fg',
    'var(--rc-color-warning-fg)',
    'color.amber.700 / color.amber.300',
  ],
  ['Warning solid', 'warning.solid', 'var(--rc-color-warning-solid)', 'color.amber.500'],
  [
    'Warning solid hover',
    'warning.solidHover',
    'var(--rc-color-warning-solid-hover)',
    'color.amber.600 / color.amber.400',
  ],
  [
    'Warning solid active',
    'warning.solidActive',
    'var(--rc-color-warning-solid-active)',
    'color.amber.700 / color.amber.300',
  ],
  ['Warning contrast', 'warning.contrast', 'var(--rc-color-warning-contrast)', 'color.white'],
  ['Info soft', 'info.soft', 'var(--rc-color-info-soft)', 'color.neutral.100 / color.neutral.800'],
  [
    'Info soft hover',
    'info.softHover',
    'var(--rc-color-info-soft-hover)',
    'color.neutral.200 / color.neutral.700',
  ],
  [
    'Info soft active',
    'info.softActive',
    'var(--rc-color-info-soft-active)',
    'color.neutral.300 / color.neutral.600',
  ],
  [
    'Info border',
    'info.border',
    'var(--rc-color-info-border)',
    'color.neutral.300 / color.neutral.700',
  ],
  ['Info focus ring', 'info.focusRing', 'var(--rc-color-info-focus-ring)', 'color.info.border'],
  [
    'Info foreground',
    'info.fg',
    'var(--rc-color-info-fg)',
    'color.neutral.700 / color.neutral.300',
  ],
  [
    'Info solid',
    'info.solid',
    'var(--rc-color-info-solid)',
    'color.neutral.200 / color.neutral.700',
  ],
  [
    'Info solid hover',
    'info.solidHover',
    'var(--rc-color-info-solid-hover)',
    'color.neutral.300 / color.neutral.600',
  ],
  [
    'Info solid active',
    'info.solidActive',
    'var(--rc-color-info-solid-active)',
    'color.neutral.400 / color.neutral.500',
  ],
  [
    'Info contrast',
    'info.contrast',
    'var(--rc-color-info-contrast)',
    'color.neutral.900 / color.neutral.50',
  ],
  ['Danger soft', 'danger.soft', 'var(--rc-color-danger-soft)', 'color.red.50 / color.red.950'],
  [
    'Danger soft hover',
    'danger.softHover',
    'var(--rc-color-danger-soft-hover)',
    'color.red.100 / color.red.900',
  ],
  [
    'Danger soft active',
    'danger.softActive',
    'var(--rc-color-danger-soft-active)',
    'color.red.200 / color.red.800',
  ],
  [
    'Danger border',
    'danger.border',
    'var(--rc-color-danger-border)',
    'color.red.300 / color.red.700',
  ],
  [
    'Danger focus ring',
    'danger.focusRing',
    'var(--rc-color-danger-focus-ring)',
    'color.danger.border',
  ],
  ['Danger foreground', 'danger.fg', 'var(--rc-color-danger-fg)', 'color.red.700 / color.red.300'],
  ['Danger solid', 'danger.solid', 'var(--rc-color-danger-solid)', 'color.red.500'],
  [
    'Danger solid hover',
    'danger.solidHover',
    'var(--rc-color-danger-solid-hover)',
    'color.red.600 / color.red.400',
  ],
  [
    'Danger solid active',
    'danger.solidActive',
    'var(--rc-color-danger-solid-active)',
    'color.red.700 / color.red.300',
  ],
  ['Danger contrast', 'danger.contrast', 'var(--rc-color-danger-contrast)', 'color.white'],
  [
    'Action fg',
    'action.fg',
    'var(--rc-color-action-fg)',
    'color.text.primary / color.text.secondary',
  ],
  [
    'Action fg disabled',
    'action.fgDisabled',
    'var(--rc-color-action-fg-disabled)',
    'color.text.muted',
  ],
  [
    'Action bg hover',
    'action.bgHover',
    'var(--rc-color-action-bg-hover)',
    'color.neutral.100 / color.neutral.800',
  ],
  [
    'Action bg active',
    'action.bgActive',
    'var(--rc-color-action-bg-active)',
    'color.neutral.200 / color.neutral.700',
  ],
  [
    'Action bg selected',
    'action.bgSelected',
    'var(--rc-color-action-bg-selected)',
    'color.neutral.200 / brand.soft',
  ],
  [
    'Action bg disabled',
    'action.bgDisabled',
    'var(--rc-color-action-bg-disabled)',
    'color.neutral.100 / color.neutral.800',
  ],
  [
    'Action bg focus',
    'action.bgFocus',
    'var(--rc-color-action-bg-focus)',
    'color.neutral.100 / color.neutral.800',
  ],
  ['Primary bg', 'control.primary.bg', 'var(--rc-color-control-primary-bg)', 'color.brand.solid'],
  [
    'Primary hover',
    'control.primary.bgHover',
    'var(--rc-color-control-primary-bg-hover)',
    'color.brand.solidHover',
  ],
  [
    'Primary active',
    'control.primary.bgActive',
    'var(--rc-color-control-primary-bg-active)',
    'color.neutral.700 / color.orange.700',
  ],
  ['Primary fg', 'control.primary.fg', 'var(--rc-color-control-primary-fg)', 'color.brand.fg'],
  [
    'Primary fg contrast',
    'control.primary.fgContrast',
    'var(--rc-color-control-primary-fg-contrast)',
    'color.brand.contrast',
  ],
  [
    'Primary border',
    'control.primary.border',
    'var(--rc-color-control-primary-border)',
    'color.brand.solid',
  ],
  [
    'Primary border hover',
    'control.primary.borderHover',
    'var(--rc-color-control-primary-border-hover)',
    'color.brand.solidHover',
  ],
  [
    'Secondary bg',
    'control.secondary.bg',
    'var(--rc-color-control-secondary-bg)',
    'color.surface.panel',
  ],
  [
    'Secondary hover',
    'control.secondary.bgHover',
    'var(--rc-color-control-secondary-bg-hover)',
    'color.action.bgHover',
  ],
  [
    'Secondary active',
    'control.secondary.bgActive',
    'var(--rc-color-control-secondary-bg-active)',
    'color.action.bgActive',
  ],
  [
    'Secondary fg',
    'control.secondary.fg',
    'var(--rc-color-control-secondary-fg)',
    'color.text.primary',
  ],
  [
    'Secondary fg contrast',
    'control.secondary.fgContrast',
    'var(--rc-color-control-secondary-fg-contrast)',
    'color.text.primary',
  ],
  [
    'Secondary border',
    'control.secondary.border',
    'var(--rc-color-control-secondary-border)',
    'color.border.default',
  ],
  [
    'Secondary border hover',
    'control.secondary.borderHover',
    'var(--rc-color-control-secondary-border-hover)',
    'color.border.strong',
  ],
  [
    'Canvas',
    'surface.canvas',
    'var(--rc-color-surface-canvas)',
    'color.neutral.100 / color.neutral.950',
  ],
  [
    'Panel',
    'surface.panel',
    'var(--rc-color-surface-panel)',
    'color.neutral.0 / color.neutral.900',
  ],
  [
    'Elevated',
    'surface.elevated',
    'var(--rc-color-surface-elevated)',
    'color.neutral.0 + shadow.raised / color.neutral.800',
  ],
  [
    'Inverse',
    'surface.inverse',
    'var(--rc-color-surface-inverse)',
    'color.neutral.950 / color.neutral.0',
  ],
  [
    'Text primary',
    'text.primary',
    'var(--rc-color-text-primary)',
    'color.neutral.950 / color.neutral.50',
  ],
  [
    'Text secondary',
    'text.secondary',
    'var(--rc-color-text-secondary)',
    'color.neutral.700 / color.neutral.300',
  ],
  [
    'Text muted',
    'text.muted',
    'var(--rc-color-text-muted)',
    'color.neutral.500 / color.neutral.400',
  ],
  [
    'Text inverse',
    'text.inverse',
    'var(--rc-color-text-inverse)',
    'color.neutral.0 / color.neutral.950',
  ],
  [
    'Border subtle',
    'border.subtle',
    'var(--rc-color-border-subtle)',
    'color.neutral.200 / color.neutral.800',
  ],
  [
    'Border default',
    'border.default',
    'var(--rc-color-border-default)',
    'color.neutral.300 / color.neutral.700',
  ],
  ['Border strong', 'border.strong', 'var(--rc-color-border-strong)', 'color.neutral.500'],
  ['Border focus', 'border.focus', 'var(--rc-color-border-focus)', 'color.neutral.500'],
  ['Common black', 'common.black', 'var(--rc-color-common-black)', 'color.black'],
  ['Common white', 'common.white', 'var(--rc-color-common-white)', 'color.white'],
];
...
export const muiPaletteRoles = [
  ...
  // Common anchors
  ['Common black', 'common.black', 'color.common.black'],
  ['Common white', 'common.white', 'color.common.white'],
  // Controls
  ...
  ['Primary contrast', 'primary.contrastText', 'color.control.primary.fgContrast'],
  ...
  ['Secondary contrast', 'secondary.contrastText', 'color.control.secondary.fgContrast'],
  // Status
  ...
  ['Success contrast', 'success.contrastText', 'color.success.contrast'],
  ...
  ['Warning contrast', 'warning.contrastText', 'color.warning.contrast'],
  ...
  // Grey ramp (+ accent aliases)
  ['Grey 50', 'grey.50', 'color.neutral.50'],
  ['Grey 100', 'grey.100', 'color.neutral.100'],
  ['Grey 200', 'grey.200', 'color.neutral.200'],
  ['Grey 300', 'grey.300', 'color.neutral.300'],
  ['Grey 400', 'grey.400', 'color.neutral.400'],
  ['Grey 500', 'grey.500', 'color.neutral.500'],
  ['Grey 600', 'grey.600', 'color.neutral.600'],
  ['Grey 700', 'grey.700', 'color.neutral.700'],
  ['Grey 800', 'grey.800', 'color.neutral.800'],
  ['Grey 900', 'grey.900', 'color.neutral.900'],
  ['Grey A100', 'grey.A100', 'color.neutral.100'],
  ['Grey A200', 'grey.A200', 'color.neutral.200'],
  ['Grey A400', 'grey.A400', 'color.neutral.400'],
  ['Grey A700', 'grey.A700', 'color.neutral.700'],
] as const;
