...
- 💡 AGENTS.md can document MCP usage hints (e.g. _"When you need to search docs, use the `context7` MCP server"_) — opencode reads them naturally as part of the always-on rules
